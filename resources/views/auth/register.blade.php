                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="first_name">Nombres Completos:</label><span
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                   ...
                                   placeholder="Establecer contraseña de cuenta" name="password" tabindex="2" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <label for="password_confirmation"
                                   class="control-label">Confirmar contraseña:</label><span
                                    class="text-danger">*</span>
                            <input id="password_confirmation" type="password" placeholder="Confirmar contraseña de la cuenta"
